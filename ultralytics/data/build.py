...
from ultralytics.data.dataset import GroundingDataset, YOLODataset, FasterRCNNDataset, YOLOMultiModalDataset
...
def build_fasterrcnn_dataset(cfg, img_path, batch, data, mode="train", rect=False):
    """Build and return a YOLO dataset based on configuration parameters."""
